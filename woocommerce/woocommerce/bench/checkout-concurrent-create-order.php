...
return function (): array {
	...
	$create_order = static function ( array $posted_data ): int {
	...
	$public_side_effect = array(
		...
		'cart_count_after_second'             => WC()->cart->get_cart_contents_count(),
		'sets_order_awaiting_payment'         => $session_after_first_create_order > 0 || $session_after_second_create_order > 0,
		'clears_cart'                         => 0 === $cart_count_after_first_create_order || 0 === WC()->cart->get_cart_contents_count(),
	);
	...
	$guardrails = array(
		...
		'changed_cart_retry_uses_new_cart_hash'                   => wc_get_order( $changed_retry_id )->get_cart_hash() === $changed_cart['cart_hash'] && $changed_original_hash !== $changed_cart['cart_hash'],
	...
	$artifact = array(
		...
		'retry_behavior'         => array(
			...
			'changed_retry_hash'     => wc_get_order( $changed_retry_id )->get_cart_hash(),
		),
